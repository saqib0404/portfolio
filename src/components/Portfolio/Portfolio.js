...
const Portfolio = () => {
    return (
        <section className='pt-20 md:pt-28 mx-4 md:mx-32'>
            <div className="section-header text-center"><h2 className='text-3xl font-semibold underline mb-6'>Portfolio</h2></div>
            <div className="projects gap-8 grid md:grid-cols-2 lg:md:grid-cols-3">
                ...
                <div className="card card-compact border border-slate-800 bg-slate-900 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center mt-2">
                            <a href='https://github.com/saqib0404/resale-bikes-client' target='_blank' className="btn btn-sm btn-info">Git-Client</a>
                            <a href='https://github.com/saqib0404/resell-bikes-server' target='_blank' className="btn btn-sm btn-info">Git-Server</a>
                            <a className='btn btn-sm btn-info' href="https://resell-bikes.web.app/" target='_blank'><AiOutlineLink /></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="card card-compact border border-slate-800 bg-slate-900  bg-inhert shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center mt-2">
                            <a href='https://github.com/saqib0404/davids-burger-client' target='_blank' className="btn btn-sm btn-info">Git-Client</a>
                            <a href='https://github.com/saqib0404/devids-burger-server' target='_blank' className="btn btn-sm btn-info">Git-Server</a>
                            <a className='btn btn-sm btn-info' href="https://davids-burger.web.app/" target='_blank'><AiOutlineLink /></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="card card-compact border border-slate-800 bg-slate-900 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center mt-2">
                            <a href='https://github.com/saqib0404/market-holder-client' target='_blank' className="btn btn-sm btn-info">Git-Client</a>
                            <a href='https://github.com/saqib0404/market-holder-server' target='_blank' className="btn btn-sm btn-info">Git-Server</a>
                            <a className='btn btn-sm btn-info' href="https://market-holder.web.app/" target='_blank'><AiOutlineLink /></a>
                        </div>
                    </div>
                </div>
